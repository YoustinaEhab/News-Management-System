    ...
    ui(new Ui::News_page)
{
    ...
    QFile file1("D:/PC1/Youstina/Data Structure Project/categories.txt");
    qDebug()<<"File1 opened";
...
void News_page::loadNewsFromFile(){
    Load_Spammed();
    QFile file("D:/PC1/Youstina/Data Structure Project/news.txt");
    qDebug()<<"spam loaded";
    bool spammed=false;
...
void News_page::initCommentsMap(){
    QFile file("D:/PC1/Youstina/Data Structure Project/Comments.txt");
...
{
    QFile file ("D:/PC1/Youstina/Data Structure Project/spammed_news.txt");
